...
public class AdressesSAXParser {

	private static ArrayList<Cat> cats = new ArrayList<Cat>();

	public static void main(String[] args) {

		File file = new File("C:\\Eclipse_Workspace\\XML_and_XMLParsers\\src\\sax_parser\\file.xml");
		File fileResult = new File("C:\\Eclipse_Workspace\\XML_and_XMLParsers\\src\\sax_parser\\fileResult.xml");
